...
export class BackendService {
  ...
  // this.getRequestHOF(this.http.get, this.serverHostname + '/api/stores/search?' + fullQuery);
  ...
  searchStores(query, location= '') {
    ...
    return this.http.get(`${this.serverHostname}/api/stores/search?${fullQuery}`, {headers: this.headers})
      .map(res => res.json());
  }
